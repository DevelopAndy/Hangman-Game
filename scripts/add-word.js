...
let words = ["caballo", "perro", "gato", "manzana", "pera", "desayuno", "huevo", "cocina", "doctor", "verano", "invierno", "vaso", "hormiga", "pantalon", "codigo", "abejas", "perdon", "Dios", "pereza", "sandwich", "pepino", "tuberculo", "persona", "frances", "torre", "maravilla", "maiz", "prensa", "hola", "programa", "proceso"]; // words to guess
